...
import { getTimetable, initializeEmptyTimetable, getSubjects, getStaff, getSettings, saveTimetable } from "../../../data/dataService2";
...
const Index = () => {
  ...
  const handleRegenerateTimetable = () => {
    ...
    alert("Generating timetable for sem3 A")
    try {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8 px-4">
        <TimetableHeader semester="sem3" section="B" />
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <TimetableDisplay semester="sem3" section="A" key={lastUpdated} />
          <TimetableLegend semester="sem3" section="A" />
